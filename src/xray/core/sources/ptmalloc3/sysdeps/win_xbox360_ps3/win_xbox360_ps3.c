...
#	define LONG				long
#	define ATOMIC_LONG_TYPE	uint32_t
#elif defined(_XBOX)
#	define ATOMIC_LONG_TYPE	volatile LONG
#	include <xtl.h>
#else // #ifndef _XBOX
#	define ATOMIC_LONG_TYPE	volatile LONG
...
#if defined(_M_IX86)
static INLINE LONG interlockedexchange(ATOMIC_LONG_TYPE *data, LONG value)
{
	LONG myret;
	__asm
	{
...
#include <cell/atomic.h>
 #define interlockedexchange cellAtomicStore32
...
/* Wait for spin lock */
static INLINE LONG slwait (ATOMIC_LONG_TYPE *sl) {
...
#ifdef _MSC_VER
static INLINE LONG sltrywait (ATOMIC_LONG_TYPE *sl) {
    return (interlockedexchange (sl, 1) != 0);
}
#endif // #ifdef _MSC_VER

/* Release spin lock */
static INLINE LONG slrelease (ATOMIC_LONG_TYPE *sl) {
    interlockedexchange (sl, 0);
    return 0;
}

/* Spin lock for emulation code */
static ATOMIC_LONG_TYPE g_sl;
...
//        g_pagesize = 4096;
//#elif defined(SN_TARGET_PS3) // #elif defined(_XBOX)
//        g_pagesize = 64*1024;
//#else // #elif defined(SN_TARGET_PS3)
