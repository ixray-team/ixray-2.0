...
namespace editor {
	...
	/// <summary>
	/// Summary for terrain_flatten_control_tab
	/// </summary>
	public ref class terrain_raiselower_control_tab : public System::Windows::Forms::UserControl
	{
	public:
		terrain_raiselower_control_tab(tool_terrain^ t):m_tool(t),m_in_sync(false)
		{
			InitializeComponent();
			in_constructor();
			//
	...
	protected:
		...
		/// </summary>
		~terrain_raiselower_control_tab()
		{
			if (components)
			{
				delete components;
	...
	private: ::gTrackBar::gTrackBar^  height_track_bar;
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(terrain_raiselower_control_tab::typeid));
			this->height_track_bar = (gcnew ::gTrackBar::gTrackBar());
			...
			// height_track_bar
			// 
			this->height_track_bar->AButColorA = System::Drawing::Color::CornflowerBlue;
			this->height_track_bar->AButColorB = System::Drawing::Color::Lavender;
			this->height_track_bar->AButColorBorder = System::Drawing::Color::SteelBlue;
			this->height_track_bar->ArrowColorDown = System::Drawing::Color::GhostWhite;
			this->height_track_bar->ArrowColorHover = System::Drawing::Color::DarkBlue;
			this->height_track_bar->ArrowColorUp = System::Drawing::Color::LightSteelBlue;
			this->height_track_bar->BackColor = System::Drawing::SystemColors::Control;
			this->height_track_bar->BorderColor = System::Drawing::Color::Black;
			this->height_track_bar->BorderShow = false;
			this->height_track_bar->BrushDirection = System::Drawing::Drawing2D::LinearGradientMode::Horizontal;
			this->height_track_bar->BrushStyle = gTrackBar::gTrackBar::eBrushStyle::Path;
			this->height_track_bar->ChangeLarge = 1;
			this->height_track_bar->ChangeSmall = 1;
			this->height_track_bar->ColorDown = System::Drawing::Color::CornflowerBlue;
			this->height_track_bar->ColorDownBorder = System::Drawing::Color::DarkSlateBlue;
			this->height_track_bar->ColorDownHiLt = System::Drawing::Color::AliceBlue;
			this->height_track_bar->ColorHover = System::Drawing::Color::RoyalBlue;
			this->height_track_bar->ColorHoverBorder = System::Drawing::Color::Blue;
			this->height_track_bar->ColorHoverHiLt = System::Drawing::Color::White;
			this->height_track_bar->ColorUp = System::Drawing::Color::MediumBlue;
			this->height_track_bar->ColorUpBorder = System::Drawing::Color::DarkBlue;
			this->height_track_bar->ColorUpHiLt = System::Drawing::Color::AliceBlue;
			this->height_track_bar->Dock = System::Windows::Forms::DockStyle::Top;
			this->height_track_bar->FloatValue = true;
			this->height_track_bar->FloatValueFont = (gcnew System::Drawing::Font(L"Arial", 8, System::Drawing::FontStyle::Bold));
			this->height_track_bar->FloatValueFontColor = System::Drawing::Color::MediumBlue;
			this->height_track_bar->fltValue = 0;
			this->height_track_bar->intValue = 0;
			this->height_track_bar->is_integer = false;
			this->height_track_bar->Label = L"Height";
			this->height_track_bar->LabelAlighnment = System::Drawing::StringAlignment::Near;
			this->height_track_bar->LabelColor = System::Drawing::Color::Black;
			this->height_track_bar->LabelFont = (gcnew System::Drawing::Font(L"Arial", 9));
			this->height_track_bar->LabelPadding = System::Windows::Forms::Padding(3);
			this->height_track_bar->LabelShow = true;
			this->height_track_bar->Location = System::Drawing::Point(0, 135);
			this->height_track_bar->Margin = System::Windows::Forms::Padding(2, 3, 2, 3);
			this->height_track_bar->MaxValue = 100;
			this->height_track_bar->MinValue = -100;
			this->height_track_bar->Name = L"height_track_bar";
			this->height_track_bar->Orientation = System::Windows::Forms::Orientation::Horizontal;
			this->height_track_bar->ShowFocus = false;
			this->height_track_bar->Size = System::Drawing::Size(239, 47);
			this->height_track_bar->SliderCapEnd = System::Drawing::Drawing2D::LineCap::Round;
			this->height_track_bar->SliderCapStart = System::Drawing::Drawing2D::LineCap::Round;
			this->height_track_bar->SliderColorHigh = System::Drawing::Color::DarkGray;
			this->height_track_bar->SliderColorLow = System::Drawing::Color::Red;
			this->height_track_bar->SliderFocalPt = (cli::safe_cast<System::Drawing::PointF >(resources->GetObject(L"height_track_bar.SliderFocalPt")));
			this->height_track_bar->SliderHighlightPt = (cli::safe_cast<System::Drawing::PointF >(resources->GetObject(L"height_track_bar.SliderHighlightPt")));
			this->height_track_bar->SliderShape = gTrackBar::gTrackBar::eShape::Rectangle;
			this->height_track_bar->SliderSize = System::Drawing::Size(20, 10);
			this->height_track_bar->SliderWidth = 1;
			this->height_track_bar->TabIndex = 10;
			this->height_track_bar->TickColor = System::Drawing::Color::DarkGray;
			this->height_track_bar->TickInterval = 0.1F;
			this->height_track_bar->TickType = gTrackBar::gTrackBar::eTickType::Middle;
			this->height_track_bar->TickWidth = 10;
			this->height_track_bar->UpDownAutoWidth = true;
			this->height_track_bar->UpDownWidth = 30;
			this->height_track_bar->ValueBox = gTrackBar::gTrackBar::eValueBox::Left;
			this->height_track_bar->ValueBoxBackColor = System::Drawing::Color::White;
			this->height_track_bar->ValueBoxBorder = System::Drawing::SystemColors::ActiveBorder;
			this->height_track_bar->ValueBoxFont = (gcnew System::Drawing::Font(L"Arial", 8.25F));
			this->height_track_bar->ValueBoxFontColor = System::Drawing::SystemColors::ControlText;
			this->height_track_bar->ValueBoxShape = gTrackBar::gTrackBar::eShape::Rectangle;
			this->height_track_bar->ValueBoxSize = System::Drawing::Size(40, 20);
			this->height_track_bar->ValueChanged += gcnew gTrackBar::gTrackBar::ValueChangedEventHandler(this, &terrain_raiselower_control_tab::sync);
			// 
			...
			this->distortion_track_bar->ValueChanged += gcnew gTrackBar::gTrackBar::ValueChangedEventHandler(this, &terrain_raiselower_control_tab::sync);
			// 
			// hardness_track_bar
			// 
			...
			this->hardness_track_bar->ValueChanged += gcnew gTrackBar::gTrackBar::ValueChangedEventHandler(this, &terrain_raiselower_control_tab::sync);
			// 
			// radius_track_bar
			// 
			...
			this->radius_track_bar->ValueChanged += gcnew gTrackBar::gTrackBar::ValueChangedEventHandler(this, &terrain_raiselower_control_tab::sync);
			// 
			// terrain_raiselower_control_tab
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->Controls->Add(this->height_track_bar);
			...
			this->Name = L"terrain_raiselower_control_tab";
			this->Size = System::Drawing::Size(239, 201);
