...
namespace editor {
	...
	/// </summary>
	public ref class terrain_flatten_control_tab : public System::Windows::Forms::UserControl
	{
	public:
		terrain_flatten_control_tab(tool_terrain^ t):m_tool(t),m_in_sync(false)
		{
			InitializeComponent();
			in_constructor();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(terrain_flatten_control_tab::typeid));
			...
			this->distortion_track_bar->ValueChanged += gcnew gTrackBar::gTrackBar::ValueChangedEventHandler(this, &terrain_flatten_control_tab::sync);
			// 
			// hardness_track_bar
			// 
			...
			this->hardness_track_bar->ValueChanged += gcnew gTrackBar::gTrackBar::ValueChangedEventHandler(this, &terrain_flatten_control_tab::sync);
			// 
			// radius_track_bar
			// 
			...
			this->radius_track_bar->ValueChanged += gcnew gTrackBar::gTrackBar::ValueChangedEventHandler(this, &terrain_flatten_control_tab::sync);
			// 
			// height_track_bar
			// 
			...
			this->height_track_bar->TabIndex = 11;
			...
			this->height_track_bar->ValueChanged += gcnew gTrackBar::gTrackBar::ValueChangedEventHandler(this, &terrain_flatten_control_tab::sync);
			// 
			// terrain_flatten_control_tab
			// 
			...
			this->Name = L"terrain_flatten_control_tab";
			this->Size = System::Drawing::Size(239, 192);
