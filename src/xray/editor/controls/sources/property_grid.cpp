...
#include <xray/editor/controls/property_container_interface.h>
#include <xray/editor/controls/property_incrementable.h>
...
using xray::editor::controls::property_container_interface;
using xray::editor::controls::property_value;
using xray::editor::controls::property_mouse_events;
using xray::editor::controls::property_incrementable;
...
void property_grid::OnChildControlMouseDoubleClick	(Object^ object, System::Windows::Forms::MouseEventArgs^ e)
{
	...
	ASSERT							(descriptor_raw);
	PropertySpecDescriptor^			descriptor = dynamic_cast<PropertySpecDescriptor^>(descriptor_raw);
	if ( !descriptor )
		return;
