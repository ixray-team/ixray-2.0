...
#ifndef TRANSFORM_CONTROLS_RENDERER_H_INCLUDED
#define TRANSFORM_CONTROLS_RENDERER_H_INCLUDED

#include <xray/render/base/transform_control.h>

// Needed for DebugVertices, DebugVertexIndices	
...
private:
	...
	debug::detail::renderer::DebugVertices		m_center_plane_points;
	debug::detail::renderer::DebugVertexIndices	m_torus_outer_indexes;
};
...
private:
	...
	debug::detail::renderer::DebugVertices		m_torus_vertexes;
	debug::detail::renderer::DebugVertexIndices	m_torus_indexes;

	debug::detail::renderer::DebugVertices		m_torus_outer_vertexes;
	debug::detail::renderer::DebugVertexIndices	m_torus_outer_indexes;

	debug::detail::renderer::DebugVertices		m_working_vertexes;
};
...
#endif // #ifndef TRANSFORM_CONTROLS_RENDERER_H_INCLUDED