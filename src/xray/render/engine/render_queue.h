...
//
//#ifdef USE_DX10_OLD
//	key_rq(res_vs_hw* vs, res_gs_hw* gs, res_ps_hw* ps, res_state* state, res_texture_list* tlist, u32 id, float dist_sq)
//#else
//	key_rq(res_vs_hw* vs, res_ps_hw* ps, res_state* state, res_texture_list* tlist, u32 id, float dist_sq)
//#endif
//	{
//		m_qword = 0;
//		u64 vs_id = vs->get_id();
...
//	u32		m_id;
//#ifdef USE_DX10
//	KeyDist(res_vs_hw* vs, res_gs_hw* gs, res_ps_hw* ps, res_state* state, res_texture_list* tlist, u32 id, float dist_sq)
//#else
//	KeyDist(res_vs_hw* vs, res_ps_hw* ps, res_state* state, res_texture_list* tlist, u32 id, float dist_sq)
//#endif
//	{
//		m_dist = dist_sq;
//		m_id = id;
