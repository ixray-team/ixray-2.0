...
#include <xray/render/engine/editor_visual.h>
...
// 	void 			update_ib( u32 buffer_id, xray::vectora<xray::render::buffer_fragment> const& fragments);
	...
	ref_effect		get_shader( u32 idx) {ASSERT( idx<m_effects.size()); return m_effects[idx];}
...
// 	typedef render::vector< res_buffer* >				VertexBuffers;
// 	typedef render::vector< res_buffer* >				IndexBuffers;
