...
public:
	...
	int		add_texture			( render::texture_string const& name, bool deferred_load = false);
	void	remove_texture		( u32 id);
	bool	exchange_texture	( render::texture_string const& old_texture, render::texture_string const& new_texture, bool deffered_load = false);
	int		get_texture_id		( render::texture_string const& name);
...
inline	void				load_texture	( u32 ind);
	...
	terrain_texture_item	m_texture_items[render::terrain_texture_max_count];
