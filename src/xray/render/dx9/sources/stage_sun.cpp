...
//	z = center_pt.z;
	...
	float4x4	smap_texel_adjust = float4x4(
...
//		}
	...
	// setup stencil
	be.set_stencil(TRUE, D3DCMP_LESSEQUAL, m_context->m_light_marker_id, 0xff, 0x00);
...
void stage_sun::phase_sun_mask(const float3& light_dir)
{
